        ...
        <div className="carousel-inner relative overflow-hidden w-full">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  "url('https://images.unsplash.com/photo-1550439062-609e1531270e?ixlib=rb-1.2.1&auto=format&fit=crop&w=1600&q=80')",
              }}
            >
      ...
      <section className="bg-white py-8">
        <div className="container py-8 px-6 mx-auto">
          ...
          <p className="mb-8">
            ...
            <Link href="#">random link</Link> adipiscing elit, sed do eiusmod
